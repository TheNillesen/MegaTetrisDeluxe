...
namespace Client
{
    class Text
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, "Rotate left: Q", keyPos + new Vector2(0, 3 * lineSpacing), color, 0, Vector2.Zero, 1, SpriteEffects.None, 1);
            spriteBatch.DrawString(font, "Rotate right: E", keyPos + new Vector2(0, 4 * lineSpacing), color, 0, Vector2.Zero, 1, SpriteEffects.None, 1);
